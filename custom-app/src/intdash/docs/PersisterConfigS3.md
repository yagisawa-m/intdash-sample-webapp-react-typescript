...
**s3** | [**PersisterConfigS3S3**](PersisterConfigS3S3.md) |  | [default to undefined]
**format** | [**PersisterConfigAttributeS3Format**](PersisterConfigAttributeS3Format.md) |  | [default to undefined]
...
```typescript
import { PersisterConfigS3 } from './api';

const instance: PersisterConfigS3 = {
    uuid,
    name,
    type,
    s3,
