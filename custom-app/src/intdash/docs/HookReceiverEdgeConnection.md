...
**action** | [**HookEdgeConnectionAction**](HookEdgeConnectionAction.md) |  | [default to undefined]
...
```typescript
import { HookReceiverEdgeConnection } from './api';

const instance: HookReceiverEdgeConnection = {
    delivery_uuid,
    hook_uuid,
    resource_type,
    action,
