...
**detail** | [**MeasurementMarkerDetailPoint**](MeasurementMarkerDetailPoint.md) |  | [optional] [default to undefined]

## Example

```typescript
import { MeasurementMarkerPostRequestPoint } from './api';

const instance: MeasurementMarkerPostRequestPoint = {
    name,
    description,
    type,
    tag,
