...
**action** | [**HookProjectEdgeAction**](HookProjectEdgeAction.md) |  | [default to undefined]
...
```typescript
import { HookReceiverProjectEdge } from './api';

const instance: HookReceiverProjectEdge = {
    delivery_uuid,
    hook_uuid,
    resource_type,
    action,
