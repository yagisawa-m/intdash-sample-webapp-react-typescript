...
**basetime_type** | [**MediaMeasurementBaseTimeType**](MediaMeasurementBaseTimeType.md) |  | [default to undefined]
...
**processed_ratio** | **number** | 代わりに &#x60;sequences.received_sequence_numbers_ratio&#x60; を使用してください。処理済み率を表します。 | [default to undefined]
...
```typescript
import { MediaMeasurement } from './api';

const instance: MediaMeasurement = {
    uuid,
    name,
    description,
    basetime,
