# PersisterConfigTimestreamTimestream
...
**table** | **string** |  | [default to undefined]
...
```typescript
import { PersisterConfigTimestreamTimestream } from './api';

const instance: PersisterConfigTimestreamTimestream = {
    region,
    database,
    table,
    endpoint,
