...
**detail** | [**MeasurementMarkerDetailPoint**](MeasurementMarkerDetailPoint.md) |  | [default to undefined]

## Example

```typescript
import { MeasurementMarkerPoint } from './api';

const instance: MeasurementMarkerPoint = {
    uuid,
    name,
    description,
    type,
