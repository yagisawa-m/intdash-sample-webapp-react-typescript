...
**detail** | [**MeasurementMarkerDetailRange**](MeasurementMarkerDetailRange.md) |  | [default to undefined]

## Example

```typescript
import { MeasurementMarkerRange } from './api';

const instance: MeasurementMarkerRange = {
    uuid,
    name,
    description,
    type,
